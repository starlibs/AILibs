...
import util.logic.LiteralParam;
...
public class StandardProblemFactory {
	...
	public static STNPlanningProblem getDockworkerProblem() {
		...
		StripsPlanningDomain dwrStripsDomain = (StripsPlanningDomain) util.planning.model.strips.StandardProblemFactory.getDockworkerProblem().getDomain();
