...
public class ForwardDecompositionHTNPlannerFactory<V extends Comparable<V>> implements IObservableGraphBasedHTNPlanningAlgorithmFactory<TFDNode,String,V> {
	...
	@Override
	public IObservableGraphBasedHTNPlanningAlgorithm<TFDNode,String, V> newAlgorithm(IHTNPlanningProblem problem, int numberOfCPUs) {
		return new ForwardDecompositionHTNPlanner<>(problem, numberOfCPUs);
	}

	@Override
	public IObservableGraphBasedHTNPlanningAlgorithm<TFDNode,String, V> newAlgorithm(IHTNPlanningProblem problem, IObservableORGraphSearchFactory<TFDNode, String, V> searchFactory, INodeEvaluator<TFDNode, V> nodeEvaluator, int numberOfCPUs) {
