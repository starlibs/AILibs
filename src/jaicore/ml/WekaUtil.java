...
public class WekaUtil {
  ...
  public static <L> Instances fromJAICoreInstances(final LabeledInstances<L> instances) {
    ...
    /*
     * if the instances object is labeled, create the label entry and create a list of all the possible
     * labels
     */
    Map<Object, Double> labelMap = new HashMap<>();
    int c = 0;
    boolean isNominal = false;
    for (Object o : instances.getOccurringLabels()) {
  ...
  public static jaicore.ml.interfaces.LabeledInstances<String> toJAICoreLabeledInstances(final Instances wekaInstances) {
  ...
  public static Collection<String> getClassesDeclaredInDataset(final Instances data) {
