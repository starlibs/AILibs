...
public interface IExperimentConfig extends Mutable {
	  ...
	  /* experiment results must be stored in a database. The table is the one where the experiments will be maintained */
