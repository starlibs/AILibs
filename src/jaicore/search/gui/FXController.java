...
//        rec.loadFromFile(file);
    ...
    /**
     *  If the program already has a recorder, which records the events of the search, the gui can work with this recorder.
     * @param recorder
     *      A recorder which is listening to the events of a search.
     */
