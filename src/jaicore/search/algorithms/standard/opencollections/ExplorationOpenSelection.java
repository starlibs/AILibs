...
public class ExplorationOpenSelection<N,V extends Comparable<V>,W extends Comparable<W>> implements OpenCollection<Node<N, V>> {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExplorationOpenSelection.class);
	
	private final OpenCollection<Node<N, V>> primaryOpen;
	...
	public ExplorationOpenSelection(OpenCollection<Node<N, V>> primaryOpen, INodeEvaluator<N, W> explorationEvaluator, int explorationPhaseLength, int exploitationPhaseLength) {
		super();
		this.primaryOpen = primaryOpen;
