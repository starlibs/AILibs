package de.upb.crc901.mlplan.testbed;
...
import de.upb.crc901.mlplan.core.TaskProblemGenerator;
...
public class TestbedCompositionBuilderDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		BestFirst<TFDNode, String> compositionAlgorithm = new BestFirst<>(generator, n -> 0.0);
