...
public class Table2CollectorWithChunks {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    individualInitMap.put("candidate", "0individual");
    ...
    homoInitMap.put("candidate", "1homogeneous");
    ...
    heteroInitMap.put("candidate", "2heterogeneous");
    ...
    baggingInitMap.put("candidate", "3bagging");
    ...
    ensemblesInitMap.put("candidate", "4ensembles");
    TaskChunk<Task> ensemblesTaskChunk = TaskChunkUtil.readFromMySQLResultSet(
        adapter.getResultsOfQuery(
            "SELECT substring_index(substring_index(dataset,'/',-1),'\\\\',-1) as dataset, classifier,seed,errorRate FROM homogeneousensemblesofreductionstumps"),
        ensemblesInitMap);
    toRemove.put("errorRate", "-1");
    ...
    unitedIndividualChunks.tTest("dataset", "candidate", "errorRate", "0individual", "tTest");
    unitedEnsembleChunks.tTest("dataset", "candidate", "errorRate", "3bagging", "tTest");
    ...
    for (Task t : unitedChunks) {
      ...
      t.store("dataset", t.getValueAsString("dataset").substring(0, t.getValueAsString("dataset").lastIndexOf(".")));
    }
