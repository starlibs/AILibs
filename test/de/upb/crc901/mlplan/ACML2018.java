...
public class ACML2018 {
	...
	public void test() throws Exception {
		...
		/* read data and split */
		Instances data = new Instances(new BufferedReader(new FileReader(new File("../ML-Plan/testrsc/multilabel/birds.arff"))));
...
//		mlplan.registerListener(new HASCOSQLEventLogger<>(new MySQLAdapter("hsqldb:hsql", "localhost", "SA", "", "testdb", new Properties())));
		...
		hasco.gatherSolutions(split.get(0), 60 * 1000 * 10);
