...
public class ShapeletTransformRefTest {
	...
	public void testSubseqDistance() {
		...
		System.out.println(dist.calculate(new double[] { 4, 2, 4, 6, 5 }, 0));
		System.out.println("Online took " + (System.currentTimeMillis() - timeStart) + " ms.");
		...
		System.out.println(dist2.calculate(new double[] { 4, 2, 4, 6, 5 }, 0));
		System.out.println("Normal took " + (System.currentTimeMillis() - timeStart) + " ms.");

		System.out.println(Arrays.toString(dist.zNormalise(new double[] { 2, 4, 6 }, false)));
	}
