...
public class MLPlanRankExperimentEvaluator implements IExperimentSetEvaluator {
	...
	public void evaluate(ExperimentDBEntry experimentEntry, SQLAdapter adapter,
		...
		if (dsInstances == null) {
			...
			if (dataSetVariations.size() != 1)
				throw new IllegalStateException(
						"HASCOFE has not generated the expected amount of data set variations.");
		...
		double mlPlanScore = EvaluationUtils.evaluateMLPlan(MLPLAN_TIMEOUT_S, dsInstances, MLPLAN_SPLIT_RATIO, seed,
				logger, false, numCPUs);
