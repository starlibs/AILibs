...
/**
 * A characterizer for MLPipelines. It characterizes pipelines using an ontology and a tree mining algorithm. The ontology is used to get a characterization of a pipeline element; from the characterization of all pipelines elements and
 * their parameters, a tree is then built. The trees retrieved from a number of training examples for pipelines are then used to find frequent patterns in the pipelines. A new pipeline is then characterizes by which of these patterns appear
 * in it.
 *
 * @author Helena Graf
 *
...
public class WEKAPipelineCharacterizer implements IPipelineCharacterizer {
	...
	/**
	 * The algorithm used by the pipeline characterizer to find frequent subtrees in deduced tree representations of given pipelines
	 */
	private FrequentSubtreeFinder treeMiner;

	/**
	 * The frequent patterns found in the tree representations of pipelines by the tree mining algorithm
	 */
	private List<String> foundPipelinePatterns;

	/**
	 * The minimum support required for a pattern to be considered frequent by the tree miner
	 */
	...
	/**
	 * Creates a new pipeline characterizer that uses the given descriptions of parameters to characterize MLPipelines.
	 *
	 * @param componentParameters
	 *            The description of parameters in the current configuration together with their refinements.
	 */
	public WEKAPipelineCharacterizer(final INumericParameterRefinementConfigurationMap componentParameters) {
	...
	/**
	 * Build this pipeline characterizer from a file of patterns. The pattern need to be UTF-8 encoded strings and each line specifies exactly one pattern.
	 *
	 * @param file
	...
	/**
	 * Builds the pipeline characterizer with a default list of patterns, which was generated by a random search over the algorithm space of weka.
	 */
	...
	public double[] characterize(final IComponentInstance pipeline) {
		...
		String treeRepresentation = new ComponentInstanceStringConverter(this.ontologyConnector, new ArrayList<>(), this.componentParameters).makeStringTreeRepresentation(pipeline);
	...
	/**
	 *
	 * Returns the amount of found pipeline patterns, which is the length of a characterization.
	 *
	 ...
	 *
	 * @return The minimum support a tree pattern must have to be considered frequent
	 */
	 ...
	 *
	 * @param minSupport
	 *            The minimum support a tree pattern must have to be considered frequent
	 */
