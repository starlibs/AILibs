...
public class WekaMLPlanWekaClassifier extends MLPlanWekaClassifier {
	...
	public WekaMLPlanWekaClassifier(MLPlanWekaBuilder builder) throws IOException {
		...
		DyadRankingBasedNodeEvaluator<TFDNode, Double> preferenceNodeEvaluator = new DyadRankingBasedNodeEvaluator<>(getComponents(), null, 10, 3, new Random(42), null, null);
