package de.upb.crc901.mlplan.multiclass.wekamlplan.service;
...
import de.upb.crc901.mlplan.multiclass.wekamlplan.service.MLPipelinePlan.MLPipe;
import de.upb.crc901.mlplan.multiclass.wekamlplan.service.MLPipelinePlan.WekaAttributeSelectionPipe;
...
/**
 *
 * Note, while this class is serializable, it MUST NOT BE CLONED USING AbstractClassifier.makeCopy, because the references to the used services are serialized and, hence, makeCopy does not work properly. Instead, use the clone method (as
 * adopted by WekaUtils.clone).
 *
 * @author fmohr
 *
 */
@SuppressWarnings("serial")
public class MLServicePipeline implements Classifier, Serializable, IInstancesClassifier {
