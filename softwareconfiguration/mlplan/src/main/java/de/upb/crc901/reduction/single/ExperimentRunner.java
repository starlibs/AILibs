...
public class ExperimentRunner<T extends ISplitter> {
	...
	public Map<String, Object> conductSingleOneStepReductionExperiment(ReductionExperiment experiment) throws Exception {
		...
		MonteCarloCrossValidationEvaluator mccv = new MonteCarloCrossValidationEvaluator(new ISimpleSLCBasedSplitEvaluator(new ZeroOneLoss()), mccvRepeats, outerSplit.get(0), .7, seed);
