...
public class ML2PlanARFFExample {
	...
	public static void main(final String[] args) throws Exception {
		...
		ML2PlanMekaClassifier mlplan = new MekaML2PlanMekaClassifier(new ML2PlanMekaBuilder().withSearchSpaceConfig(new File("conf/automl/searchmodels/meka/tinytest-meka.json")));
		...
		try {
			...
			System.out
					.println("Chosen model is: " + ((MultilabelMLPipeline) mlplan.getSelectedClassifier()).toString());
