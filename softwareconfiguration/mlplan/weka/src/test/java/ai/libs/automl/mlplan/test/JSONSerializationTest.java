...
public class JSONSerializationTest {
	...
	private static final String ALL_JSON_FILES = "performance_stuff.json";
	...
	public void testSerializeComponentInstance() throws URISyntaxException, IOException {
		...
		mapper.readValue(this.oldPlainJson, ComponentInstance.class);
	...
	@Test
	public void testAllComponentInstances() throws IOException, URISyntaxException {
		...
		ObjectMapper mapper = new ObjectMapper();
		mapper.registerModule(new HASCOJacksonModule(loader.getComponents()));
		File allJsonFile = Paths.get(this.getClass().getClassLoader().getResource(ALL_JSON_FILES).toURI()).toFile();
