...
public class HASCOViaFD<ISearch extends GraphSearchWithPathEvaluationsInput<TFDNode, String, V>, V extends Comparable<V>> extends HASCO<ISearch, TFDNode, String, V> {
	...
	public HASCOViaFD(final RefinementConfiguredSoftwareConfigurationProblem<V> configurationProblem, final IOptimalPathInORGraphSearchFactory<ISearch, TFDNode, String, V> searchFactory,
