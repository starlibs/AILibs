...
import ai.libs.jaicore.ml.core.dataset.cache.FoldBasedSubsetInstruction;
import ai.libs.jaicore.ml.core.dataset.cache.Instruction;
...
public class ReproducibleInstances extends Instances {
	 ...
	 */
	public static ReproducibleInstances fromHistory(final InstructionGraph history, final Pair<String, Integer> outputUnitOfHistory) throws DatasetTraceInstructionFailedException, InterruptedException {
		ReproducibleInstances result = new ReproducibleInstances(((WekaInstances) history.getDataForUnit(outputUnitOfHistory)).getList());
	...
	public static ReproducibleInstances fromOpenML(final int id, final String apiKey) throws DatasetTraceInstructionFailedException, InterruptedException {
		...
		ReproducibleInstances result = new ReproducibleInstances(((WekaInstances) graph.getDataForUnit(outputUnit)).getList());
	...
	public static ReproducibleInstances fromARFF(final File arffFile) throws DatasetTraceInstructionFailedException, InterruptedException {
		InstructionGraph graph = new InstructionGraph();
	 ...
	 */
	public ReproducibleInstances reduceWithInstruction(final String nameOfRefinementInstruction, final Instruction instruction, final int outputOfRefinementInstruction)
