...
extends CostSensitivePlanningToSearchProblemReduction<N, A, V, IHTNPlanningProblem, GraphSearchWithPathEvaluationsInput<N, A, V>, IEvaluatedPath<N, A, V>> {
	...
	public CostSensitivePlanningToStandardSearchProblemReduction(final IHierarchicalPlanningToGraphSearchReduction<N, A, IHTNPlanningProblem, IPlan, GraphSearchInput<N, A>, IPath<N, A>> baseReduction) {
