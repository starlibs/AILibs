...
public class StandardProblemFactory {
	...
	private StandardProblemFactory() {
	...
	public static StripsPlanningProblem getBlocksWorldProblem() {
		...
		operations.add(new StripsOperation("unstack", Arrays.asList(new VariableParam("x"), new VariableParam("y")),
		...
		return new StripsPlanningProblem(domain, init, goal);
	}
	...
	public static StripsPlanningProblem getDockworkerProblem() {
		...
		/* create planning domain */
		List<StripsOperation> operations = new ArrayList<>();
		operations.add(new StripsOperation("move", Arrays.asList(new VariableParam("l"), new VariableParam("m"), new VariableParam("r")),
				new Monom("adjacent(l,m) & at(r,l) & !occupied(m)"), new Monom("at(r,m) & occupied(m)"), new Monom("at(r,l) & occupied(l)")));
		operations.add(
				new StripsOperation("load", Arrays.asList(new VariableParam("l"), new VariableParam("k"), new VariableParam("r"), new VariableParam("c")),
						new Monom("belong(k,l) & holding(k,c) & at(r,l) & unloaded(r)"), new Monom("empty(k) & loaded(r,c)"), new Monom("holding(k,c) & unloaded(r)")));
		operations.add(
				new StripsOperation("unload", Arrays.asList(new VariableParam("l"), new VariableParam("k"), new VariableParam("r"), new VariableParam("c")),
		...
		operations.add(new StripsOperation("put",
				Arrays.asList(new VariableParam("k"), new VariableParam("l"), new VariableParam("c"), new VariableParam("d"), new VariableParam("p")),
