...
public class ForwardDecompositionHTNPlannerBasedOnBestFirst<PA extends Action, IPlanning extends IHTNPlanningProblem, V extends Comparable<V>> extends ForwardDecompositionHTNPlanner<PA, IPlanning, V, GraphSearchWithSubpathEvaluationsInput<TFDNode, String, V>> {
