...
public class MCTSEnhancedTTSPTester extends EnhancedTTSPTester<GraphSearchWithPathEvaluationsInput<EnhancedTTSPNode,String,Double>,EvaluatedSearchGraphPath<EnhancedTTSPNode, String,Double>,Node<EnhancedTTSPNode,Double>, String> {
	...
	@Override
	public IGraphSearchFactory<GraphSearchWithPathEvaluationsInput<EnhancedTTSPNode, String, Double>, EvaluatedSearchGraphPath<EnhancedTTSPNode, String,Double>, EnhancedTTSPNode, String, Node<EnhancedTTSPNode, Double>, String> getFactory() {
