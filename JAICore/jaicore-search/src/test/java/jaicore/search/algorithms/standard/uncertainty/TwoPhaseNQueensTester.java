...
public class TwoPhaseNQueensTester extends NQueenProblemSet<GraphSearchWithUncertaintyBasedSubpathEvaluationInput<QueenNode,String,Double>, EvaluatedSearchGraphPath<QueenNode, String, Double>> {
