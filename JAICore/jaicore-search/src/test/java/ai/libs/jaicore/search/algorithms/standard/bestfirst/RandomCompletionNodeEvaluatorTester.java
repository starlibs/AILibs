...
public class RandomCompletionNodeEvaluatorTester extends TimeAwareNodeEvaluatorTester<RandomCompletionBasedNodeEvaluator<EnhancedTTSPState, String, Double>> {
	...
	public RandomCompletionBasedNodeEvaluator<EnhancedTTSPState, String, Double> getNodeEvaluator(final int problemDifficulty, final IObjectEvaluator<IPath<EnhancedTTSPState, String>, Double> oe, final int seed,
		...
		IObjectEvaluator<IPath<EnhancedTTSPState, String>, Double> se = new IObjectEvaluator<IPath<EnhancedTTSPState, String>, Double>() {

			@Override
			public Double evaluate(final IPath<EnhancedTTSPState, String> solutionPath) throws InterruptedException, ObjectEvaluationFailedException {
