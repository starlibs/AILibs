...
public class UUCT<N, A> extends MCTS<N, A> {
	...
	public UUCT(final IMDP<N, A, Double> input, final IPolicy<N, A> defaultPolicy, final IUCBUtilityFunction utility, final int maxIterations, final double gamma, final double epsilon, final boolean tabooExhaustedNodes) {
