...
public class TAGMCTS<N, A> extends MCTS<N, A> {
	...
	public TAGMCTS(final IMDP<N, A, Double> input, final IPolicy<N, A> defaultPolicy, final double c, final int s, final double delta, final double thresholdIncrement, final int maxIterations, final double gamma, final double epsilon, final Random r, final boolean tabooExhaustedNodes) {
