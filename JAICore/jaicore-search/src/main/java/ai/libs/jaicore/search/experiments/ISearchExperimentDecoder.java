...
public interface ISearchExperimentDecoder<N, A, I extends IGraphSearchWithPathEvaluationsInput<N, A, Double>, O extends IEvaluatedPath<N, A, Double>, P extends IOptimalPathInORGraphSearch<? extends I, ? extends O, N, A, Double>> extends IExperimentDecoder<I, P> {
