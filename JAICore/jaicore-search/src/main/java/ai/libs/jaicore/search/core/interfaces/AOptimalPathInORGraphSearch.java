 ...
 * @param <Asearch>
 */
public abstract class AOptimalPathInORGraphSearch<I extends IGraphSearchInput<N, A>, N, A, V extends Comparable<V>> extends AOptimizer<I, EvaluatedSearchGraphPath<N, A, V>, V>
