...
public class UCT<N, A> extends MCTS<N, A> {
	...
	public UCT(final IMDP<N, A, Double> input, final IPolicy<N, A> defaultPolicy, final int maxIterations, final double gamma, final double epsilon, final Random r, final boolean tabooExhaustedNodes) {
