...
public class SPUCT<N, A> extends MCTS<N, A> {
	...
	public SPUCT(final IMDP<N, A, Double> input, final IPolicy<N, A> defaultPolicy, final double bigD, final double maxIterations, final double gamma, final double epsilon, final boolean tabooExhaustedNodes) {
