...
public class DepthFirstSearchFactory<N, A> extends StandardORGraphSearchFactory<IGraphSearchInput<N, A>, SearchGraphPath<N, A>,N, A, Double, DepthFirstSearch<N, A>> {
	...
	@Override
	public DepthFirstSearch<N, A> getAlgorithm(final IGraphSearchInput<N, A> input) {
