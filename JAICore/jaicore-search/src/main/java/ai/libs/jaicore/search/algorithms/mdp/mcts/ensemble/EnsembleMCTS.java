...
public class EnsembleMCTS<N, A> extends MCTS<N, A> {
	...
	public EnsembleMCTS(final IMDP<N, A, Double> input, final IPolicy<N, A> defaultPolicy, final Collection<IPathUpdatablePolicy<N, A, Double>> treePolicies, final int maxIterations, final double gamma, final double epsilon, final Random random, final boolean tabooExhaustedNodes) {
