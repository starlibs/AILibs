...
public class AStarFactory<T, A> extends StandardORGraphSearchFactory<NumberBasedAdditiveTraversalTree<T,A>, EvaluatedSearchGraphPath<T, A, Double>, T, A, Double, Node<T,Double>, A, IGraphAlgorithmListener<Node<T,Double>, A>> {
	...
	@Override
	public IGraphSearch<NumberBasedAdditiveTraversalTree<T,A>, EvaluatedSearchGraphPath<T, A, Double>, T, A, Double, Node<T,Double>, A, IGraphAlgorithmListener<Node<T,Double>, A>> getAlgorithm() {
