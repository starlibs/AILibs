...
public class NodeExpansionCompletedEvent<T, A, V extends Comparable<V>> extends BestFirstEvent {
	private final Node<T, V> expandedNode;
	private final List<NodeExpansionDescription<T, A>> children;

	public NodeExpansionCompletedEvent(Node<T, V> expandedNode, List<NodeExpansionDescription<T, A>> children) {
		super();
