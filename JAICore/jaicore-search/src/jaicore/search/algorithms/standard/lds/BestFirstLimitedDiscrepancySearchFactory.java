...
public class BestFirstLimitedDiscrepancySearchFactory<T, A, V extends Comparable<V>>
		extends StandardORGraphSearchFactory<NodeRecommendedTree<T, A>, EvaluatedSearchGraphPath<T, A, V>, T, A, V, Node<T, NodeOrderList>, A, IGraphAlgorithmListener<Node<T, NodeOrderList>, A>> {
