...
public class LimitedDiscrepancySearchFactory<T, A, V extends Comparable<V>> extends StandardORGraphSearchFactory<NodeRecommendedTree<T, A>, EvaluatedSearchGraphPath<T, A,V>, T, A, V, TreeNode<T>, A, IGraphAlgorithmListener<TreeNode<T>, A>> {
