...
public class TwoPhaseNQueensTester extends NQueenTester<GraphSearchWithUncertaintyBasedSubpathEvaluationInput<QueenNode,String,Double>, EvaluatedSearchGraphPath<QueenNode, String, Double>, Node<QueenNode, Double>, String> {
