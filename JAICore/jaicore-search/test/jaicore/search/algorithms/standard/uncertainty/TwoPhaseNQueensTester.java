...
public class TwoPhaseNQueensTester extends NQueenTester<UncertainlyEvaluatedTraversalTree<QueenNode,String,Double>, EvaluatedSearchGraphPath<QueenNode, String, Double>, Node<QueenNode, Double>, String> {
