...
public class BestFirstKnapsackTester extends KnapsackTester<GraphSearchWithSubpathEvaluationsInput<KnapsackNode, String, Double>, EvaluatedSearchGraphPath<KnapsackNode, String, Double>, Node<KnapsackNode,Double>, String> {
	
	@Override
	public IGraphSearchFactory<GraphSearchWithSubpathEvaluationsInput<KnapsackNode, String, Double>, EvaluatedSearchGraphPath<KnapsackNode, String, Double>, KnapsackNode, String, Node<KnapsackNode,Double>, String> getFactory() {
