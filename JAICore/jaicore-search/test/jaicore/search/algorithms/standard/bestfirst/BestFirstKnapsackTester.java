...
public class BestFirstKnapsackTester extends KnapsackOptimizationTest<GeneralEvaluatedTraversalTree<KnapsackNode, String, Double>, EvaluatedSearchGraphPath<KnapsackNode, String, Double>, Node<KnapsackNode,Double>, String> {
	
	@Override
	public IGraphSearchFactory<GeneralEvaluatedTraversalTree<KnapsackNode, String, Double>, EvaluatedSearchGraphPath<KnapsackNode, String, Double>, KnapsackNode, String, Double, Node<KnapsackNode,Double>, String, IGraphAlgorithmListener<Node<KnapsackNode,Double>, String>> getFactory() {
