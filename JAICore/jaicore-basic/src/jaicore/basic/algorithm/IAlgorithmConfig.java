...
public interface IAlgorithmConfig extends Mutable {
	...
	/**
	 * @return The main memory that is available to be used. This is merely a
	 *         documentation variable since the true memory must be set over the JVM
	 *         initialization anyway and cannot be restricted inside of it
	 */
	@Key(K_MEMORY)
	@DefaultValue("256")
	public int memory();
