...
public class OpenShopProblem {
	...
	public void printWorkcenters(final OutputStream out) {
		...
		try {
			...
			System.err.println("Error in printing work centers");
		}
	}

	public void printWorkcenters() {
		this.printWorkcenters(System.out);
	}
	 ...
	 *            BufferedWriter
	 */
	public void printJobs(final OutputStream out) {
		StringBuilder sb = new StringBuilder();
		try {
			...
			System.err.println("Error in printing jobs");
		}
	}

	public void printJobs() {
		this.printJobs(System.out);
	}
}