...
public class ShotgunEnsembleClassifier extends ASimplifiedTSClassifier<Integer> {
     ...
     */
    public ShotgunEnsembleClassifier(ShotgunEnsembleAlgorithm algorithm, double factor) {
        super(algorithm);
     ...
     * @throws PredictionException
     */
    protected Map<Integer, List<Integer>> calculateWindowLengthPredictions(TimeSeriesDataset dataset)
            throws PredictionException {
    ...
    protected List<Integer> mostFrequentLabelsFromWindowLengthPredicitions(
            Map<Integer, List<Integer>> windowLengthPredicitions) {
        ...
        for (int i = 0; i < numberOfInstances; i++) {
            ...
            int mostFrequentLabelForInstance = mostFrequentLabelFromWindowLengthPredicitions(windowLabelsForInstance);
    ...
    public Integer predict(double[] univInstance) throws PredictionException {
        ...
        Map<Integer, Integer> windowLengthPredicitions = calculateWindowLengthPredictions(univInstance);
        int prediciton = mostFrequentLabelFromWindowLengthPredicitions(windowLengthPredicitions);
        return prediciton;
    }
    ...
    public List<Integer> predict(TimeSeriesDataset dataset) throws PredictionException {
        ...
        Map<Integer, List<Integer>> windowLengthPredicitions = calculateWindowLengthPredictions(dataset);
        List<Integer> predictions = mostFrequentLabelsFromWindowLengthPredicitions(windowLengthPredicitions);
        return predictions;
    }
