...
/**
 * Das könnte definitiv 0/1 loss sein.
 * 
 * @author elppa
 *
 */
public class MulticlassEvaluator implements BasicMLEvaluator, Serializable {
	...
	private static final Logger logger = LoggerFactory.getLogger(MulticlassEvaluator.class);
	...
	@Override
	public double getErrorRateForRandomSplit(final Classifier c, final Instances data, final double splitSize)
			throws Exception {
		if (c == null) {
	...
	@Override
	public double getErrorRateForSplit(final Classifier c, final Instances train, final Instances test)
			throws Exception {
