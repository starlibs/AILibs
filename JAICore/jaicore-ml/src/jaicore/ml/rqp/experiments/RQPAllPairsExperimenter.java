...
import jaicore.ml.rqp.AugSpaceAllPairs;
...
public class RQPAllPairsExperimenter {

	public static void main(String[] args) {
		IRQPAllPairsConfig m = ConfigCache.getOrCreate(IRQPAllPairsConfig.class);
		...
		ExperimentRunner runner = new ExperimentRunner(new IExperimentSetEvaluator() {
			...
			public void evaluate(ExperimentDBEntry experimentEntry, SQLAdapter adapter,
				...
				Instances augDataTrainMin = new AugSpaceAllPairs().apply(dataTrain);
