...
public class ExtendedBagging extends SingleEnhancerDerivedRandomizableMultipleClassifiersCombiner
  ...
  public void buildClassifier(final Instances data) throws Exception {
    ...
    if (this.getRepresentCopiesUsingWeights() && !(checkIfAnyClassifierIsInstanceOfWeightedInstancesHandler(m_Classifiers))) {
  ...
  public void generatePartition(final Instances data) throws Exception {
    ...
    if (checkIfAllClassifierIsInstanceOfPartitionGenerator(m_Classifiers)) {
