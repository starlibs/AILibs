...
public class ExtendedAdaBoostM1 extends AdaBoostM1 {
	...
	public void initializeClassifier(Instances data) throws Exception {
		...
		if(!this.m_ClassifiersArrayList.isEmpty()) {
		    ...
		    this.m_Classifiers = m_ClassifiersArrayList.toArray(this.m_Classifiers);
	...
	public void setOptions(final String[] options) throws Exception {
		...
		if(Utils.getFlag('A', options)) {
			this.m_ClassifiersArrayList = addCurrentBaseClassifierToClassifierArray(this.m_Classifier);
		}
	}
	 ...
	 */
	private ArrayList<Classifier> addCurrentBaseClassifierToClassifierArray(Classifier classifier) {
