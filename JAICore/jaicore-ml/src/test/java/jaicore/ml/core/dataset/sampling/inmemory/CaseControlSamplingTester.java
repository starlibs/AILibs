...
public class CaseControlSamplingTester extends GeneralSamplingTester {
	...
	public IAlgorithm<?, ?> getAlgorithm(IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance> dataset) {
		CaseControlSamplingFactory<INumericLabeledAttributeArrayInstance, IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance>> factory = new CaseControlSamplingFactory<>();
		if (dataset != null) {
