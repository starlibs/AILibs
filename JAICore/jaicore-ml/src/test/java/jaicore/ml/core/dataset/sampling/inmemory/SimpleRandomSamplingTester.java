...
public class SimpleRandomSamplingTester extends GeneralSamplingTester<Object> {
	...
	public IAlgorithm<?, ?> getAlgorithm(IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance<Object>, Object> dataset) {
		SimpleRandomSamplingFactory<INumericLabeledAttributeArrayInstance<Object>, IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance<Object>, Object>> factory = new SimpleRandomSamplingFactory<>();
		if (dataset != null) {
