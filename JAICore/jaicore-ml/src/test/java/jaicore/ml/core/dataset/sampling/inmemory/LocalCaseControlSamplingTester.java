...
public class LocalCaseControlSamplingTester extends GeneralSamplingTester {
	...
	public IAlgorithm<?, ?> getAlgorithm(IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance> dataset) {
		LocalCaseControlSamplingFactory<INumericLabeledAttributeArrayInstance, IOrderedLabeledAttributeArrayDataset<INumericLabeledAttributeArrayInstance>> factory = new LocalCaseControlSamplingFactory<>();
		if (dataset != null) {
