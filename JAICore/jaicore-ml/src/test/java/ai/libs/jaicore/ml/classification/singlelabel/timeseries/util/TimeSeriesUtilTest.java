...
public class TimeSeriesUtilTest {
	...
	public void normalizeINDArrayTest() {
		...
		Assert.assertTrue(Nd4j.create(new double[] { -1, 0, 1 }).equalsWithEps(TimeSeriesUtil.normalizeINDArray(testArray, false), EPS_DELTA));
	}
	...
	public void testMean() {
		double mean = TimeSeriesUtil.mean(this.T);
	...
	public void testMean2() {
		double mean = TimeSeriesUtil.mean(this.U);
	...
	public void testVariance() {
		double variance = TimeSeriesUtil.variance(this.T);
	...
	public void testVariance2() {
		double variance = TimeSeriesUtil.variance(this.U);
	...
	public void testStandardDeviation() {
		double standardDeviation = TimeSeriesUtil.standardDeviation(this.T);
	...
	public void testStandardDeviation2() {
		double standardDeviation = TimeSeriesUtil.standardDeviation(this.U);
		double expectation = 0;
