...
import ai.libs.jaicore.ml.tsc.distances.ManhattanDistance;
import ai.libs.jaicore.ml.tsc.exceptions.TimeSeriesLengthException;

/**
 * Test suite for the {@link ai.libs.jaicore.ml.tsc.distances.ManhattanDistance}
 * implementation.
 * 
 * @author fischor
 */
public class ManhattanDistanceTest {
	 ...
	 */
	@Test(expected = TimeSeriesLengthException.class)
