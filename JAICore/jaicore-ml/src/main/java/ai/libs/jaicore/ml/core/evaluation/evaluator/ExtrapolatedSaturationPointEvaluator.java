 ...
 * @author Lukas Brandt
 */
public class ExtrapolatedSaturationPointEvaluator<I extends ILabeledInstance, D extends ILabeledDataset<I>> implements IClassifierEvaluator<IClassifier<I, D>> {
