...
public class TimeSeriesUtil {
	 ...
	 */
	public static int getNumberOfClasses(final TimeSeriesDataset2 dataset) {
	 ...
	 */
	public static List<Integer> getClassesInDataset(final TimeSeriesDataset2 dataset) {
		if (dataset == null || dataset.getTargets() == null) {
			throw new IllegalArgumentException("Given parameter 'dataset' must not be null and must contain a target matrix!");
		}
	...
	/**
	 * Shuffles the given {@link TimeSeriesDataset2} object using the given
	 * <code>seed</code>.
	 *
	 * @param dataset The dataset to be shuffled
	 * @param seed The seed used within the randomized shuffling
	 */
	public static void shuffleTimeSeriesDataset(final TimeSeriesDataset2 dataset, final int seed) {
	...
	/**
	 * Functions creating two {@link TimeSeriesDataset2} objects representing the
	 ...
	 */
	public static Pair<TimeSeriesDataset2, TimeSeriesDataset2> getTrainingAndTestDataForFold(final int fold, final int numFolds, final double[][] srcValueMatrix, final int[] srcTargetMatrix) {
	 ...
	 * @return Returns a pair consisting of the training and test dataset
	 */
	private static TimeSeriesDataset2 selectTrainingDataForFold(final int fold, final int numFolds, final double[][] srcValueMatrix, final int[] srcTargetMatrix) {
	 ...
	 * @return Returns a pair consisting of the training and test dataset
	 */
	private static TimeSeriesDataset2 selectTestDataForFold(final int fold, final int numFolds, final double[][] srcValueMatrix, final int[] srcTargetMatrix) {
	...
	/**
	 * Function creating a {@link TimeSeriesDataset2} object given the
	 ...
	 * @return Returns a {@link TimeSeriesDataset2} object constructed out of the
	 *         given parameters
	 */
	public static TimeSeriesDataset2 createDatasetForMatrix(final int[] targets, final double[][]... valueMatrices) {
	 ...
	 *         given parameters
	 */
	public static TimeSeriesDataset2 createDatasetForMatrix(final double[][]... valueMatrices) {
