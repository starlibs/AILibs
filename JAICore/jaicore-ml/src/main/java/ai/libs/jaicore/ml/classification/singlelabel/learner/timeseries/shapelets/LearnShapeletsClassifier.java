...
import ai.libs.jaicore.ml.classification.singlelabel.learner.timeseries.ASimplifiedTSClassifier;
import ai.libs.jaicore.ml.classification.singlelabel.learner.timeseries.shapelets.LearnShapeletsLearningAlgorithm.ILearnShapeletsLearningAlgorithmConfig;
...
public class LearnShapeletsClassifier extends ASimplifiedTSClassifier<Integer> {
	 ...
	 */
	@Override
	public List<Integer> predict(final ai.libs.jaicore.ml.core.timeseries.dataset.TimeSeriesDataset2 dataset) throws PredictionException {
		if (!this.isTrained()) {
			throw new PredictionException("Model has not been built before!");
		}
