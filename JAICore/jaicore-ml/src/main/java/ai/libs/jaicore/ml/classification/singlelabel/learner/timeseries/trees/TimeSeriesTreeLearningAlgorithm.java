package ai.libs.jaicore.ml.classification.singlelabel.learner.timeseries.trees;

import static ai.libs.jaicore.ml.core.timeseries.dataset.TimeSeriesFeature.NUM_FEATURE_TYPES;
import static ai.libs.jaicore.ml.core.timeseries.dataset.TimeSeriesFeature.getFeatures;
...
import ai.libs.jaicore.ml.classification.singlelabel.learner.timeseries.ASimplifiedTSCLearningAlgorithm;
import ai.libs.jaicore.ml.classification.singlelabel.learner.timeseries.trees.TimeSeriesTreeClassifier.TimeSeriesTreeNodeDecisionFunction;
