 ...
 * @author Lukas Brandt
 */
public class MultiValueBinarizationTransformer {
	...
	public double[] transformAttribute(final IAttributeValue attributeToTransform) {
		...
		IMultiLabelAttributeValue value = (MultiValueAttributeValue) attributeToTransform;
		IMultiLabelAttribute type = (MultiValueAttribute) value.getAttribute();
		...
		double[] binarization = new double[domain.size()];
