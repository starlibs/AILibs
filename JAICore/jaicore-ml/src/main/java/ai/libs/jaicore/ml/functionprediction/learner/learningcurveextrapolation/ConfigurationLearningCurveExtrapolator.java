...
public class ConfigurationLearningCurveExtrapolator<I extends ILabeledInstance, D extends ILabeledDataset<I>> extends LearningCurveExtrapolator<I, D> {
	...
	public ConfigurationLearningCurveExtrapolator(final IClassifier<I, D> learner, final D dataset, final double trainsplit, final int[] anchorpoints, final ISamplingAlgorithmFactory<I, D, ASamplingAlgorithm<I, D>> samplingAlgorithmFactory,
