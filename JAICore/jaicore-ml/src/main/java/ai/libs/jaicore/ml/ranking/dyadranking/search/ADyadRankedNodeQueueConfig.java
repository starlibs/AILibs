...
public abstract class ADyadRankedNodeQueueConfig<N> implements IBestFirstQueueConfiguration<GraphSearchWithSubpathEvaluationsInput<N, String, Double>, N, String, Double> {
	 ...
	 * metafeatures
	 */
	protected IDyadRanker<IPLNetDyadRankerConfiguration> ranker;
	 ...
	 */
	public IDyadRanker<IPLNetDyadRankerConfiguration> getRanker() {
		return this.ranker;
	}
	 ...
	 */
	public void setRanker(final IDyadRanker<IPLNetDyadRankerConfiguration> ranker) {
		this.ranker = ranker;
	}
