...
public interface IClassifierEvaluatorFactory {
	...
	public IClassifierEvaluator getIClassifierEvaluator(IDataset<? extends IInstance> dataset, long seed) throws ClassifierEvaluatorConstructionFailedException;
