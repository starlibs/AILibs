...
public class ExtrapolatedSaturationPointEvaluator implements IClassifierEvaluator {
	...
	private IOrderedLabeledAttributeArrayDataset train;
	...
	private IOrderedLabeledAttributeArrayDataset test;
	...
	public ExtrapolatedSaturationPointEvaluator(final int[] anchorpoints,
			final ISamplingAlgorithmFactory<IOrderedLabeledAttributeArrayDataset, ? extends ASamplingAlgorithm<IOrderedLabeledAttributeArrayDataset>> samplingAlgorithmFactory,
					final IOrderedLabeledAttributeArrayDataset train, final double trainSplitForAnchorpointsMeasurement,
					final LearningCurveExtrapolationMethod extrapolationMethod, final long seed, final IOrderedLabeledAttributeArrayDataset test) {
		super();
	...
	public Double evaluate(final Classifier classifier) throws InterruptedException, ObjectEvaluationFailedException {
		...
		try {
			...
			ASamplingAlgorithm<IOrderedLabeledAttributeArrayDataset> samplingAlgorithm = this.samplingAlgorithmFactory
					.getAlgorithm(optimalSampleSize, this.train, new Random(this.seed));
			IOrderedLabeledAttributeArrayDataset saturationPointTrainSet = samplingAlgorithm.call();
