...
public class DerivateTransformDistance implements ITimeSeriesDistance {
    ...
    public DerivateTransformDistance(double a, double b, double c, ADerivateFilter derivate, ATransformFilter transform,
            ITimeSeriesDistance timeSeriesDistance, ITimeSeriesDistance derivateDistance,
            ITimeSeriesDistance transformDistance) {
        // Parameter checks.
        if (derivate == null)
     ...
     *                           distance of the transform values.
     */
    public DerivateTransformDistance(double a, double b, double c, ITimeSeriesDistance timeSeriesDistance,
            ITimeSeriesDistance derivateDistance, ITimeSeriesDistance transformDistance) {
        this(a, b, c, new BackwardDifferenceDerivate(), new CosineTransform(), timeSeriesDistance, derivateDistance,
                transformDistance);
    }
     ...
     *                 transform values.
     */
    public DerivateTransformDistance(double a, double b, double c, ITimeSeriesDistance distance) {
    ...
    public double distance(double[] A, double[] B) {
        ...
        return a * this.timeSeriesDistance.distance(A, B) + b * this.derivateDistance.distance(derivateA, derivateB)
                + c * this.transformDistance.distance(transformA, transformB);
    }
