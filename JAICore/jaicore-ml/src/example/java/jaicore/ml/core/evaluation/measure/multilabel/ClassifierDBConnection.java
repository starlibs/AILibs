...
public class ClassifierDBConnection implements Serializable {
	 ...
	 */
	private EEvaluationMode mode = EEvaluationMode.VALIDATION;
	 ...
	 */
	public ClassifierDBConnection(final SQLAdapter adapter, final String dataset, final String test_split_tech, final String test_fold, final String val_split_tech, final String val_fold, final String testSeed, final String valSeed)
			throws SQLException {
		// Set adapter
	 ...
	 */
	public ClassifierDBConnection(final SQLAdapter adapter, final String dataset, final String test_split_tech, final String test_fold, final String val_split_tech, final String val_fold, final String testSeed, final String valSeed,
			final int metricID) throws SQLException {
	...
	public ClassifierDBConnection(final SQLAdapter adapter, final int settingId, final int metricId) throws SQLException {
	 ...
	 *             classifier object
	 */
	public Classifier getPreTrainedSingleLabelClassifierForLabel(final String classifierName, final int label) throws SQLException, ClassNotFoundException, IOException {
	 ...
	 *             If the classifier object cannot be recreated from the database
	 */
	public Classifier getOptimalPreTrainedSingleLabelClassifierForLabel(final int label) throws SQLException, ClassNotFoundException, IOException {
		...
		List<String> values = Arrays.asList(String.valueOf(this.settingId), String.valueOf(label), String.valueOf(this.metricID));
	 ...
	 * @throws ClassNotFoundException
	 */
	public Object getPreTrainedMultilabelClassifier(final String classifierName) throws SQLException, ClassNotFoundException, IOException {
	 ...
	 *             serialization
	 */
	public Object getOptimalPreTrainedMultilabelClassifier(final String classifierName) throws SQLException, ClassNotFoundException, IOException {
		// Get fitting classifier from database
	 ...
	 *             If something goes wrong while connecting to the db
	 */
	public void updatePreTrainedMultilabelClassifier(final int id, final Object classifier) throws IOException, SQLException {
	 ...
	 *             array.
	 */
	public int addPreTrainedMultilabelClassifier(final String classifierName, final Object classifier) throws SQLException, IOException {
		HashMap<String, Object> map = new HashMap<>();
	 ...
	 *
	 */
	public int addPreTrainedSingleLabelClassifier(final Classifier classifier, final int label_index) throws IOException, SQLException {
	...
	public int getOrCreateIdForClassifier(final String classifierName) throws IOException, SQLException {
		...
		Integer id = this.getExistingIdOfClassifier(classifierName);
	 ...
	 *             If something goes wrong while connecting to the database
	 */
	public void addMeasurementsForMultilabelClassifierIfNotExists(final int classifierId, final Result result, final Map<Integer, String> metricIdsWithNames) throws SQLException {
	 ...
	 *             If something goes wrong while connecting to the db
	 */
	public void addMeasurementsForMultilabelClassifier(final int classifierId, final Result result, final Map<Integer, String> metricIdsWithNames) throws SQLException {
		for (Entry<Integer, String> metricWithId : metricIdsWithNames.entrySet()) {
			...
			try {
				...
				LOGGER.warn("Exception while trying to get the value of metric {} for classifier {}", metricWithId.getKey(), classifierId);
				continue;
			}

			LOGGER.trace("Add measured value {} for metric with id {} for classifier with id {}", measuredValue, metricWithId.getKey(), classifierId);
	 ...
	 *             If something goes wrong while connecting to the database
	 */
	public void addMeasurementsForSingleLableClassifierIfNotExists(final int classifierId, final Evaluation evaluation, final int classIndex, final Map<Integer, String> metricNames) throws SQLException {
	 ...
	 *             If something goes wrong while connecting to the database
	 */
	public void addMeasurementsForSinglelabelClassifier(final int classifierId, final Evaluation evaluation, final int classIndex, final Map<Integer, String> namedMetrics) throws SQLException {
		for (Entry<Integer, String> namedMetric : namedMetrics.entrySet()) {
			Double measuredValue;
			try {
				measuredValue = ClassifierMetricGetter.getValueOfMetricForSingleLabelClassifier(evaluation, namedMetric.getValue(), classIndex);
			} catch (Exception e) {
				LOGGER.warn("Exception while trying to get metric {} for classifier {}.", namedMetric.getKey(), classifierId);
				continue;
			}
	 ...
	 *             If something goes wrong while connecting to the database
	 */
	protected void addMeasurementForClassifier(final int classifierId, final int metricId, final double measuredValue) throws SQLException {
		...
		if (this.mode == EEvaluationMode.TEST) {
	 ...
	 *             If something goes wrong while connecting to the database
	 */
	protected Map<Integer, String> getMissingClassifierMetrics(final int classifierId, final Map<Integer, String> metricNames) throws SQLException {
		// Build query
	 ...
	 */
	public EEvaluationMode getMode() {
		return this.mode;
	}
	 ...
	 */
	public void setMode(final EEvaluationMode mode) {
		this.mode = mode;
	}
